...
class PacketIn:
    def __init__(self, log_level=""):
        ...
        self.count = 0
        self.int_length = 0
        self.f = open("receive_log1.txt", "w")
    ...
    def handle_pkt(self, pkt):
        ...
        if eth.type == 0x0701:
            ...
            if int_hdr.int_num != 0:
                ...
                print("int_num: %d" % int_hdr.int_num)
                self.int_length += int_hdr.int_num * 26 + 2
                print("int total length: %d" % self.int_length)
                self.f.write("int total length: %d\n" % self.int_length)
        sys.stdout.flush()
